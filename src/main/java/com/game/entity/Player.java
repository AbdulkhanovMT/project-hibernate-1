...
@NamedQueries({
        @NamedQuery(name = Player.COUNT_PLAYERS,
        query = "SELECT count(p) FROM Player p"),
})
public class Player {
    public final static String COUNT_PLAYERS = "getTotalCountQuery";
    @Id
    ...
    @Column(name = "race", nullable = false) @Enumerated(EnumType.ORDINAL)
    private Race race;

    @Column(name = "profession", nullable = false) @Enumerated(EnumType.ORDINAL)
